...
class FoldSpec extends TestKit(ActorSystem("goju"))
  ...
  "To fold 1024 entries" should "return all entries in levels" in {
    ...
    val set12 = ret.toSet
    (1 to 2).foreach(i => set12.contains("value" + i) should be(true))
    (10 to 29).foreach(i => set12.contains("value" + i) should be(true))
    (100 to 299).foreach(i => set12.contains("value" + i) should be(true))
    (1000 to 1024).foreach(i => set12.contains("value" + i) should be(true))
    ...
    val set34 = ret.toSet
    (3 to 4).foreach(i => set34.contains("value" + i) should be(true))
    (30 to 49).foreach(i => set34.contains("value" + i) should be(true))
    (300 to 499).foreach(i => set34.contains("value" + i) should be(true))
    ...
    val set56 = ret.toSet
    (5 to 6).foreach(i => set56.contains("value" + i) should be(true))
    (50 to 69).foreach(i => set56.contains("value" + i) should be(true))
    (500 to 699).foreach(i => set56.contains("value" + i) should be(true))
    ...
    val set78 = ret.toSet
    (7 to 8).foreach(i => set78.contains("value" + i) should be(true))
    (70 to 89).foreach(i => set78.contains("value" + i) should be(true))
    (700 to 899).foreach(i => set78.contains("value" + i) should be(true))
    ...
    set78.contains("value9") should be(true)
    (90 to 99).foreach(i => set78.contains("value" + i) should be(true))
    (900 to 999).foreach(i => set78.contains("value" + i) should be(true))
    goju.destroy()
  }
